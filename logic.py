...
'Разработан. Готов к использованию.', 'Обновлен', 'Завершен. Не поддерживается'])]
...
if __name__ == '__main__':
    ...
    manager.insert_project([(1, 1, 'ClimateBot','...','https://github.com/Artem2025229/ClimateBot','Завершен. Не поддерживается')])